import RecAnalizadorLexer from "./generated/RecAnalizadorLexer.js";
import RecAnalizadorParser from "./generated/RecAnalizadorParser.js";
import { CustomRecAnalizadorVisitor } from "./CustomRecAnalizadorVisitor.js";
...
async function main() {
    ...
    let lexer = new RecAnalizadorLexer(inputStream);
    ...
    for (let token of tokens) {
        ...
        const tokenType = RecAnalizadorLexer.symbolicNames[token.type] || `UNKNOWN (${token.type})`;
    ...
    lexer = new RecAnalizadorLexer(inputStream);
    let tokenStream = new CommonTokenStream(lexer);
    let parser = new RecAnalizadorParser(tokenStream);
    ...
    if (parser.syntaxErrorsCount > 0) {
        ...
        const visitor = new CustomRecAnalizadorVisitor();
        visitor.visit(tree);
    }
}
